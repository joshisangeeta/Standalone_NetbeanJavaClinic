...
public class NetbeanJavaClinicView extends FrameView implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae)
    {
       ...
       if( ae.getActionCommand().equals("FollowUpEntry"))
       {
        ...
        if( ae.getActionCommand().equals("ContactDetails"))
       {
           counter=3;
            contact =new Contacts(counter);
       ...
       if( ae.getActionCommand().equals("CasePaper"))
       {
       ...
       if( ae.getActionCommand().equals("Phone Nos."))
       {
           //to be implemented
    ...
    private void initComponents() {
        ...
        jMenu7.setBackground(resourceMap.getColor("jMenu7.background")); // NOI18N
        jMenu7.setForeground(resourceMap.getColor("jMenu7.foreground")); // NOI18N
        jMenu7.setText(resourceMap.getString("jMenu7.text")); // NOI18N
        jMenu7.setName("jMenu7"); // NOI18N

        jMenuItem5.setBackground(resourceMap.getColor("jMenuItem5.background")); // NOI18N
        jMenuItem5.setForeground(resourceMap.getColor("jMenuItem5.foreground")); // NOI18N
