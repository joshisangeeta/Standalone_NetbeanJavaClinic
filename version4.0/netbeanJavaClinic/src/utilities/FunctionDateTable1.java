 ...
 * @author Admin
 */
public class FunctionDateTable1 {
    ...
    public static String getFunctionDate() {
        int row = FunctionDateTable1.tblCalendar.getSelectedRow();
        int column = FunctionDateTable1.tblCalendar.getSelectedColumn();
