...
public class RegiFrame extends javax.swing.JFrame implements ActionListener{
    ...
    private void initComponents() {
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "BA", "BSc", "Bcom", "BE", "MBBS", "BAMS", "PG", "CA", "Architect", "IT", "Primary", "Secondary", "Illiterate", "other", " ", " " }));
        ...
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Builder", "Business", "Carpenter", "Doctor", "Farming", "Labourer", "Lawyer", "Meson", "CGService", "MGService", "PvtService", "Student", "Teacher", "Unemployeed", " ", " " }));
