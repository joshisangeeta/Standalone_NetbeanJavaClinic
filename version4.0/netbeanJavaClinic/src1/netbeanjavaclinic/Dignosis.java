...
Appointment apt;
    ...
    private void initComponents() {
        ...
        jList2.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "ADHD", "Alcho.Dep", "Alcho.Hallu", "Anorexia Nervosa", "B.M.D.", "B.P.D.", "B.R.P.", "Bipolar-depre", "Bipolar-mania", "Bipolar-mixed", "BipolarII", "Bullimai Nervosa", "Catatonia", "Delu.Dis", "Dimensia", "Dimensia wirth Behv Dist", "G.A.D.", "Grief Reaction", "Grief Complicated", "Grief Delayed", "Hypocondriasis", "Hys.Conversion", "Hys.dissociation", "Hys.disphoria", "Hys.Psychosis", "M.D.D.", "M.D.D. with Psychotic f", "Migrane", "M.R.", "M.R.with Bhaviourial Distrb", "Monodel.Hypo.", "O.C.D.", "P.T.S.D.", "Panic.DIs", "Fpbia Specific", "PSY.Pain Dis", "Psy.Sexual Dis", "Psy.Somaic DIs", "S.A.D.", "Schiz.Form.Dis", "Schiz Paranoid", "Schiz Simple", "Schiz chronic", "Scizure dis-generalized", "Scizure-Partial complex", "Somatoform dis", " ", " ", " ", " " };
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 290, 210, -1));
